...
const Createcategory: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const categoryData = {
      ...
      CategoryActive: Boolean(formData.get("categoryActive")),
      CategorySequence: Number(formData.get("categorySequence")),
      CategoryFilterlist: formData.get("categoryFilterlist") as string,
    };
    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <FormControl>
          ...
          <FormControlLabel
            control={<Checkbox name="categoryActive" color="primary" />}
